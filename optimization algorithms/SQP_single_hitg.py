...
def SQP_fun_sin_new_new(x,error_pos_dict,alpha_pos_dict,beta_pos_dict,mRNA_df,Prot_time_df,Target_TFs):
    ...
    for R in mRNA_df.columns:
        begin_alpha, alpha_end = alpha_pos_dict[R]
...
d1 = datetime.today() # get starting time of algorithm
print(d1.strftime('%d-%m-%Y'))
...
d2 = datetime.today() # get end time of algorithm
...
name = 'SQP_HitG_50_single_{}_restarts{}_steps{}_nit{}_{}_{}_b'.format(maxiter,n_restarts,steps[0],best_res.nit,d1.strftime('%d-%m-%Y'),Time)